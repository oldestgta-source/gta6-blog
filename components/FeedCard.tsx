...
export default function FeedCard({ item }: { item: FeedItem }) {
  return (
    ...
    >
      <article className="h-full bg-vice-abyss border border-white/5 rounded-xl p-6 hover:border-white/10 transition-all duration-300 flex flex-col justify-between gap-4">
        <div>
          {/* Source + tag */}
